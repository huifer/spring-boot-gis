package com.huifer.springbootgis.exception;
...
public class GisRunTimeException extends RuntimeException {
	...
	protected GisRunTimeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
